...
class Settings(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_file='app/.env_manage', env_file_encoding='utf-8', extra='ignore')
...
config_Manage = Settings()

if not config_Manage.PUBLIC_IP:
    config_Manage.PUBLIC_IP = requests.get('https://api.ipify.org').text

BASE_WEBHOOK_URL = f"https://{config_Manage.PUBLIC_IP}:8443"
WEBHOOK_SSL_CERT = "/etc/ssl/nginx/" + config_Manage.PUBLIC_IP + ".self.crt"
WEBHOOK_SSL_KEY = "/etc/ssl/nginx/" + config_Manage.PUBLIC_IP + ".self.key"
